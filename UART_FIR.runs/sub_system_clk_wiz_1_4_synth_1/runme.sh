...
HD_PWD='C:/FPGA/UART/UART.runs/sub_system_clk_wiz_1_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_system_clk_wiz_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_clk_wiz_1_4.tcl

...
ISEStep( "vivado",
         "-log sub_system_microblaze_riscv_0_axi_periph_imp_xbar_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_microblaze_riscv_0_axi_periph_imp_xbar_3.tcl" );

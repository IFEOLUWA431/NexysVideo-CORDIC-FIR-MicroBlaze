...
HD_PWD='C:/FPGA/UART_FIR/UART_FIR/UART_FIR.runs/sub_system_dlmb_bram_if_cntlr_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_system_dlmb_bram_if_cntlr_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_dlmb_bram_if_cntlr_3.tcl

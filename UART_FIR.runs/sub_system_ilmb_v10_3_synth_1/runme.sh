...
HD_PWD='C:/FPGA/UART/UART.runs/sub_system_ilmb_v10_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_system_ilmb_v10_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_ilmb_v10_3.tcl

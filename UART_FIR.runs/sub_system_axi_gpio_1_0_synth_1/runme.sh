...
HD_PWD='C:/FPGA/UART_FIR/UART_FIR/UART_FIR.runs/sub_system_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_system_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_axi_gpio_1_0.tcl

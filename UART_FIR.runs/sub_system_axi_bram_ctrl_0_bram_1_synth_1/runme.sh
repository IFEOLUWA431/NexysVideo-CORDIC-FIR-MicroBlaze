...
HD_PWD='C:/FPGA/UART_FIR/UART_FIR/UART_FIR.runs/sub_system_axi_bram_ctrl_0_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_system_axi_bram_ctrl_0_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_system_axi_bram_ctrl_0_bram_1.tcl
